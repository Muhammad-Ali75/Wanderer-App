  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Image
            source={require("../../images/pcHotelisb.webp")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/pc2.jpeg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/pc3.jpeg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
        ...
        <View style={{ marginLeft: 75, marginTop: -17 }}>
          <Image
        ...
        <View style={{ marginLeft: 130, marginTop: -17 }}>
          <Text style={{ color: "#F4A40E" }}> 4.5 </Text>
        </View>
        <View style={{ marginLeft: 157, marginTop: -19.5 }}>
      ...
      >
        ...
        >
          <Image
            source={require("../../images/marg1.webp")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/marg2.jpg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/marg3.jpg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
      ...
      >
        ...
        >
          <Image
            source={require("../../images/serena1.jpg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/serena2.jpg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
          ...
          <Image
            source={require("../../images/serena3.jpg")}
            style={{
              marginTop: 20,
              marginLeft: 20,
              borderRadius: 10,
